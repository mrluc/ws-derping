...
require.define("/sim.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var Backbone, Box2D, b, exports, lib, _,
  ...
  lib.PhysicalSimulation = (function() {
    ...
    function PhysicalSimulation() {
      ...
      var angle, body, bodyDef, doSleep, fixDef, i, iters, position, timeStep, _i;
      ...
      for (i = _i = 0; _i <= 60; i = ++_i) {
        this.world.Step(timeStep, iters);
    ...
    PhysicalSimulation.prototype.addCircle = function() {
      var bodyDef, canvasheight, canvaswidth, f, fixDef, scale;
      bodyDef = new b.b2BodyDef;
      fixDef = new b.b2FixtureDef;
      fixDef.density = .5;
      fixDef.friction = 0.1;
  ...
  lib.Player = (function(_super) {

    __extends(Player, _super);

    function Player(name) {
      this.name = name;
      this.some_action = __bind(this.some_action, this);

    }

    Player.prototype.some_action = function(intAmount) {
      return console.log("OMG CALLED ----- " + [intAmount]);
    };
  ...
  lib.WorldEventParser = (function() {

    function WorldEventParser() {}

    return WorldEventParser;
  ...
  lib.World = (function() {
    ...
    function World() {
      this.time = Date.now();
      this.sim = new lib.PhysicalSimulation;
...
require.define("/assets/js/app.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var each_sim_tick, every5s, everyNs, keepGoing, log5s, nows, puts, sim, ticks, w, _, _most,
    __slice = [].slice;
  ...
  everyNs = function(seconds, fn) {
    return _.debounce(fn, seconds * 1000);
  };
  ...
  log5s = every5s(function(s) {
    return console.log(s);
  });

  log5s = _.debounce((function(s) {
    return console.log(s);
  }), 5000);

  socket.on('gameState', function(data) {
    log5s(data);
    return socket.emit('pa', {
      my: 'data'
    });
  });
  ...
  _.extend.apply(_, [w].concat(__slice.call(Box2D)));

  _.extend(w, sim.Box2D);

  each_sim_tick = function() {
    var bodies, thing;
    bodies = world.GetBodyList();
    thing = Math.random();
    return _most(bodies, 'm_next', function(o) {
